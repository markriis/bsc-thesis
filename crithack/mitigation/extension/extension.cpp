...
void CHookHelper::SDK_OnAllLoaded( ) {
    ...
    GameFunctions::MD5_PseudoRandom = ( GameFunctions::MD5_PseudoRandom_t )( server_base + MD5_PseudoRandom_offset );
    ...
    print_ext_scoped( "\t MD5_PseudoRandom: %p\n", (void*)GameFunctions::MD5_PseudoRandom );
